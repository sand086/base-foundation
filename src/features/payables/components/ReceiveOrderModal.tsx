          ...
          <div className="flex items-start space-x-3">
            ...
            <div className="grid gap-1.5 leading-none">
              ...
              <p className="text-xs text-muted-foreground">
                Marca si todos los ítems/servicios fueron recibidos según lo
                solicitado.
              </p>
            </div>
          </div>
      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="space-y-4 py-4">
          <p className="text-sm text-muted-foreground">
            Al convertir esta orden a CxP, se abrirá el formulario de registro
            de factura con los datos pre-llenados. Solo faltará ingresar el{" "}
            <strong>UUID/Folio Fiscal</strong> y subir los archivos PDF/XML.
          </p>
