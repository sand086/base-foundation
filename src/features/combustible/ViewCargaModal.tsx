      ...
      <DialogContent className="sm:max-w-[550px]">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="text-center p-4 bg-status-success-bg rounded-lg border border-status-success-border">
              ...
              <p className="text-2xl font-bold font-mono text-status-success">
                $
                {carga.total.toLocaleString("es-MX", {
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="flex items-center gap-3 p-3 bg-muted/50 rounded-lg">
              // Dentro de ViewCargaModal.tsx
              {carga.tieneEvidencia && carga.evidenciaUrl && (
                <div className="border rounded-lg overflow-hidden mt-4">
                  <p className="text-[10px] bg-slate-100 p-1 text-center font-mono text-slate-500 uppercase">
                    Evidencia Digitalizada
                  </p>
                  <img
                    // Si el backend devuelve /static/..., concatenamos la URL base de tu API
                    src={`${import.meta.env.VITE_API_URL}${carga.evidenciaUrl}`}
                    alt="Ticket"
