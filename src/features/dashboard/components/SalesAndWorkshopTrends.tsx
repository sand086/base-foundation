import {
  ...
  CartesianGrid,
  Legend,
  LabelList, // <-- NUEVO: Para mostrar los números al lado de las barras
} from "recharts";
              ...
              >
                ...
                <Tooltip
                  ...
                  formatter={(value: number, name: string) => [
                    ...
                    name, // Usa el name de los componentes directamente
                  ]}
                  contentStyle={{
          ...
          <div className="h-[250px]">
            <ResponsiveContainer width="100%" height="100%">
              <ComposedChart
                data={mechanicStats}
                layout="vertical"
                // AUMENTAMOS EL MARGEN DERECHO a 60 para que los números no se corten
              ...
              >
                ...
                {/* Barra de Órdenes con su número visible */}
                <Bar
                  xAxisId="bottom"
                ...
                {/* Barra de Gasto con su cantidad visible */}
                <Bar
                  xAxisId="top"
                  dataKey="gasto_total"
                ...
                >
                  <LabelList
                    dataKey="gasto_total"
                    position="right"
                    formatter={formatCompactCurrency} // Muestra ej: $1.2k
                    style={{
                      fontSize: "10px",
                      fontWeight: "bold",
                      fill: "#8b5cf6",
