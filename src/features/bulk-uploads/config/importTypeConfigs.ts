...
export const importTypeConfigs: ImportTypeConfig[] = [
  ...
  {
    id: "facturas_cxp",
    title: "Importar Excel SAT (CxP)",
    description:
      "Carga el Master Excel de Cuentas por Pagar. Genera proveedores y provisiona saldos.",
    icon: DollarSign,
    color: "text-emerald-500",
    backendEndpoint: "/finance/invoices/bulk-upload",
    columns: [
      { name: "uuid", excelHeader: "UUID", type: "string", required: true },
      {
        name: "rfc_emisor",
        excelHeader: "Rfc Emisor",
        type: "string",
        required: true,
      },
      {
        name: "nombre_emisor",
        excelHeader: "Nombre Emisor",
        type: "string",
        required: true,
      },
      { name: "folio", excelHeader: "Folio", type: "string", required: false },
      {
        name: "fecha_emision",
        excelHeader: "Fecha",
        type: "string",
      ...
      {
        name: "subtotal",
        excelHeader: "Sub Total",
        type: "number",
        required: true,
      },
      {
        name: "iva",
        excelHeader: "Total impuesto Trasladado",
        type: "number",
        required: false,
      },
      {
        name: "retenciones",
        excelHeader: "Total impuesto Retenido",
        type: "number",
        required: false,
      },
      { name: "total", excelHeader: "Total", type: "number", required: true },
      {
        name: "moneda",
        excelHeader: "Moneda",
        type: "string",
      ...
      {
        name: "concepto",
        excelHeader: "Conceptos",
        type: "string",
        required: false,
      },
      {
        name: "dias_credito",
        excelHeader: "dias de credtito",
        type: "number",
        required: false,
      }, // Se mapea el error ortográfico del CSV de Gustavo
    ],
    sampleData: [],
    recordCount: 0,
  },
