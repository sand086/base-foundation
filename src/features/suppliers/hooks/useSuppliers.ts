...
export const useSuppliers = () => {
  ...
  const createSupplierMut = useMutation({
    mutationFn: (data: any) =>
      SuppliersService.createSupplierApiSuppliersPost(data),
    onSuccess: () => {
  ...
  const updateSupplierMut = useMutation({
    mutationFn: ({ id, data }: { id: number; data: any }) =>
      SuppliersService.updateSupplierApiSuppliersSupplierIdPut(
        Number(id),
        data,
      ),
    onSuccess: () => {
  ...
  const deleteSupplierMut = useMutation({
    mutationFn: (id: number) =>
      SuppliersService.deleteSupplierApiSuppliersSupplierIdDelete(Number(id)),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["suppliers"] });
  ...
  const createInvoiceMut = useMutation({
    mutationFn: (data: any) =>
      SuppliersService.createInvoiceApiSuppliersInvoicesPost(data),
    onSuccess: () => {
  ...
  const updateInvoiceMut = useMutation({
    mutationFn: ({ id, data }: { id: number; data: any }) =>
      SuppliersService.updateInvoiceApiSuppliersInvoicesInvoiceIdPut(
        Number(id),
        data,
      ),
    onSuccess: () => {
  ...
  const deleteInvoiceMut = useMutation({
    mutationFn: (id: number) =>
      SuppliersService.deleteInvoiceApiSuppliersInvoicesInvoiceIdDelete(
        Number(id),
      ),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["invoices"] });
  ...
  const registerPaymentMut = useMutation({
    mutationFn: ({ id, data }: { id: number; data: any }) =>
      SuppliersService.registerPaymentApiSuppliersInvoicesInvoiceIdPaymentsPost(
        Number(id),
        data,
      ),
    onSuccess: () => {
  ...
  const createCategoryMut = useMutation({
    mutationFn: (input: { nombre: string; tipo: "fijo" | "variable" }) =>
      axiosClient
        .post<IndirectCategory>("/api/finance/indirect-categories", input)
        .then((r) => r.data),
    onSuccess: () => {
  ...
  const updateCategoryMut = useMutation({
    mutationFn: ({
      ...
      axiosClient
        .put<IndirectCategory>(`/api/finance/indirect-categories/${id}`, data)
        .then((r) => r.data),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["indirect-categories"] });
