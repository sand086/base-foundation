...
export const manualsData: ManualModule[] = [
  {
    ...
    campos: [
      { nombre: "Nombre", tipo: "texto", longitud: "100", requerido: true, descripcion: "Nombre(s) del usuario" },
      { nombre: "Apellido", tipo: "texto", longitud: "100", requerido: true, descripcion: "Apellido(s) del usuario" },
      { nombre: "Email", tipo: "email", longitud: "150", requerido: true, descripcion: "Correo electrónico único para inicio de sesión" },
      { nombre: "Teléfono", tipo: "texto", longitud: "15", requerido: false, descripcion: "Número de teléfono con lada" },
      { nombre: "Puesto", tipo: "texto", longitud: "80", requerido: false, descripcion: "Cargo o puesto dentro de la empresa" },
      { nombre: "Rol", tipo: "select", longitud: "—", requerido: true, descripcion: "Rol que define los permisos del usuario en el sistema" },
      { nombre: "Contraseña", tipo: "password", longitud: "128", requerido: true, descripcion: "Mínimo 8 caracteres, una mayúscula, un número y un símbolo" },
      { nombre: "Avatar", tipo: "imagen", longitud: "5 MB", requerido: false, descripcion: "Foto de perfil en formato JPG, PNG o WebP" },
      { nombre: "Estatus", tipo: "toggle", longitud: "—", requerido: true, descripcion: "Activo o Inactivo. Un usuario inactivo no puede iniciar sesión" },
    ],
    modales: [
      {
  ...
  },
  {
    ...
    funcionalidades: [
      ...
      "Exportación a Excel del catálogo completo",
    ],
    campos: [
      { nombre: "Razón Social", tipo: "texto", longitud: "200", requerido: true, descripcion: "Nombre legal de la empresa o persona física" },
      { nombre: "Nombre Comercial", tipo: "texto", longitud: "150", requerido: false, descripcion: "Nombre con el que se conoce al cliente comercialmente" },
      { nombre: "RFC", tipo: "texto", longitud: "13", requerido: true, descripcion: "Registro Federal de Contribuyentes (12 o 13 caracteres)" },
      { nombre: "Régimen Fiscal", tipo: "select", longitud: "—", requerido: true, descripcion: "Régimen fiscal del SAT (ej. 601 - General de Ley)" },
      { nombre: "Uso de CFDI", tipo: "select", longitud: "—", requerido: true, descripcion: "Clave de uso del comprobante fiscal (ej. G03 - Gastos en general)" },
      { nombre: "Código Postal Fiscal", tipo: "texto", longitud: "5", requerido: true, descripcion: "CP del domicilio fiscal registrado ante el SAT" },
      { nombre: "Email de Facturación", tipo: "email", longitud: "150", requerido: true, descripcion: "Correo donde se enviarán las facturas electrónicas" },
      { nombre: "Teléfono", tipo: "texto", longitud: "15", requerido: false, descripcion: "Teléfono principal de contacto" },
      { nombre: "Método de Pago", tipo: "select", longitud: "—", requerido: true, descripcion: "PPD (Pago en Parcialidades) o PUE (Pago en Una Exhibición)" },
      { nombre: "Forma de Pago", tipo: "select", longitud: "—", requerido: true, descripcion: "Clave SAT de forma de pago (ej. 03 - Transferencia electrónica)" },
      { nombre: "Días de Crédito", tipo: "número", longitud: "3", requerido: false, descripcion: "Plazo en días para el vencimiento de facturas" },
      { nombre: "Ejecutivo", tipo: "select", longitud: "—", requerido: false, descripcion: "Usuario responsable de la relación comercial" },
    ],
    modales: [
      {
    ...
    faq: [
      {
        pregunta: "¿Qué diferencia hay entre Suspender y Desactivar un cliente?",
        respuesta:
  ...
  },
  {
    ...
    funcionalidades: [
      ...
      "Exportación del catálogo de unidades a Excel",
    ],
    campos: [
      { nombre: "Número Económico", tipo: "texto", longitud: "20", requerido: true, descripcion: "Identificador interno único de la unidad dentro de la empresa" },
      { nombre: "Tipo de Unidad", tipo: "select", longitud: "—", requerido: true, descripcion: "Tractocamión, Remolque, Dolly o Utilitario" },
      { nombre: "Marca", tipo: "texto", longitud: "50", requerido: true, descripcion: "Fabricante del vehículo (ej. Kenworth, Freightliner, International)" },
      { nombre: "Modelo / Submarca", tipo: "texto", longitud: "50", requerido: true, descripcion: "Línea o submarca del vehículo (ej. T680, Cascadia)" },
      { nombre: "Año", tipo: "número", longitud: "4", requerido: true, descripcion: "Año modelo del vehículo" },
      { nombre: "VIN", tipo: "texto", longitud: "17", requerido: true, descripcion: "Número de Identificación Vehicular (Vehicle Identification Number), 17 caracteres alfanuméricos" },
      { nombre: "Placas", tipo: "texto", longitud: "10", requerido: true, descripcion: "Placas de circulación vigentes" },
      { nombre: "Color", tipo: "texto", longitud: "30", requerido: false, descripcion: "Color exterior de la unidad" },
      { nombre: "Número de Ejes", tipo: "número", longitud: "2", requerido: true, descripcion: "Cantidad de ejes de la unidad, define el esquema de llantas" },
      { nombre: "Número de Llantas", tipo: "número", longitud: "2", requerido: true, descripcion: "Cantidad total de llantas que porta la unidad" },
      { nombre: "Capacidad de Carga (ton)", tipo: "número", longitud: "6", requerido: false, descripcion: "Peso máximo de carga en toneladas" },
      { nombre: "Odómetro Actual (km)", tipo: "número", longitud: "10", requerido: false, descripcion: "Lectura actual del kilometraje de la unidad" },
      { nombre: "Operador Asignado", tipo: "select", longitud: "—", requerido: false, descripcion: "Operador actualmente responsable de la unidad" },
      { nombre: "Estatus", tipo: "select", longitud: "—", requerido: true, descripcion: "Activa, En Taller, Siniestrada o Baja" },
      { nombre: "Fecha de Alta", tipo: "fecha", longitud: "—", requerido: true, descripcion: "Fecha en que la unidad fue registrada en el sistema" },
    ],
    modales: [
      {
  ...
  },
  {
    ...
    campos: [
      { nombre: "Código Interno", tipo: "texto", longitud: "30", requerido: true, descripcion: "Identificador único de la llanta en el inventario (ej. LL-0001)" },
      { nombre: "Marca", tipo: "texto", longitud: "50", requerido: true, descripcion: "Fabricante de la llanta (ej. Michelin, Bridgestone, Continental)" },
      { nombre: "Modelo", tipo: "texto", longitud: "50", requerido: false, descripcion: "Línea o modelo específico de la llanta" },
      { nombre: "Medida", tipo: "texto", longitud: "20", requerido: true, descripcion: "Dimensiones de la llanta (ej. 295/80R22.5, 11R24.5)" },
      { nombre: "DOT", tipo: "texto", longitud: "12", requerido: false, descripcion: "Código DOT de fabricación que indica semana y año de manufactura" },
      { nombre: "Profundidad de Huella (mm)", tipo: "número", longitud: "4", requerido: true, descripcion: "Profundidad actual del dibujo en milímetros. Mínimo legal: 3mm" },
      { nombre: "Estado", tipo: "select", longitud: "—", requerido: true, descripcion: "Nueva, Montada, Almacén, En Renovado o Desecho" },
      { nombre: "Posición", tipo: "texto", longitud: "10", requerido: false, descripcion: "Posición en el chasis donde está montada (ej. 1-LI, 2-RO). Vacío si está en almacén" },
      { nombre: "Unidad Asignada", tipo: "select", longitud: "—", requerido: false, descripcion: "Unidad vehicular donde está montada actualmente la llanta" },
      { nombre: "Costo de Adquisición", tipo: "moneda", longitud: "10", requerido: false, descripcion: "Precio de compra original de la llanta en MXN" },
      { nombre: "Proveedor", tipo: "texto", longitud: "100", requerido: false, descripcion: "Proveedor o casa llantea donde se adquirió" },
      { nombre: "Km Acumulados", tipo: "número", longitud: "10", requerido: false, descripcion: "Kilómetros totales recorridos por la llanta desde su alta" },
      { nombre: "Número de Recapas", tipo: "número", longitud: "2", requerido: false, descripcion: "Cantidad de veces que la llanta ha sido renovada/recapada" },
      { nombre: "Fecha de Alta", tipo: "fecha", longitud: "—", requerido: true, descripcion: "Fecha de ingreso de la llanta al inventario" },
    ],
    modales: [
      {
    ...
    faq: [
      ...
      {
        pregunta: "¿Qué significa el indicador de color en la profundidad de huella?",
        respuesta:
  ...
  },
  {
    ...
    funcionalidades: [
      ...
      "Exportación de viajes a Excel con filtros avanzados",
    ],
    campos: [
      { nombre: "Folio / Public ID", tipo: "texto", longitud: "15", requerido: true, descripcion: "Identificador único autogenerado del viaje (ej. TRP-00142)" },
      { nombre: "Cliente", tipo: "select", longitud: "—", requerido: true, descripcion: "Cliente al que se facturará el servicio de transporte" },
      { nombre: "Origen", tipo: "texto", longitud: "200", requerido: true, descripcion: "Dirección o localidad de carga/origen del viaje" },
      { nombre: "Destino", tipo: "texto", longitud: "200", requerido: true, descripcion: "Dirección o localidad de entrega/destino del viaje" },
      { nombre: "Ruta", tipo: "select", longitud: "—", requerido: false, descripcion: "Ruta predefinida que incluye casetas, distancia y tiempo estimado" },
      { nombre: "Configuración", tipo: "select", longitud: "—", requerido: true, descripcion: "Sencillo (solo ida) o Full (ida y vuelta)" },
      { nombre: "Tractocamión", tipo: "select", longitud: "—", requerido: true, descripcion: "Unidad motriz asignada al viaje" },
      { nombre: "Remolque 1", tipo: "select", longitud: "—", requerido: true, descripcion: "Primer remolque asignado" },
      { nombre: "Remolque 2", tipo: "select", longitud: "—", requerido: false, descripcion: "Segundo remolque (solo en configuración full o doble articulado)" },
      { nombre: "Operador", tipo: "select", longitud: "—", requerido: true, descripcion: "Operador/chofer responsable del viaje" },
      { nombre: "Fecha Programada", tipo: "fecha", longitud: "—", requerido: true, descripcion: "Fecha y hora estimada de salida" },
      { nombre: "Fecha de Entrega", tipo: "fecha", longitud: "—", requerido: false, descripcion: "Fecha y hora real de entrega en destino" },
      { nombre: "Tarifa", tipo: "moneda", longitud: "12", requerido: true, descripcion: "Monto en MXN que se cobrará al cliente por el servicio" },
      { nombre: "Clave de Producto SAT", tipo: "texto", longitud: "8", requerido: true, descripcion: "Clave del catálogo SAT para la mercancía transportada" },
      { nombre: "Descripción de Mercancía", tipo: "texto", longitud: "500", requerido: true, descripcion: "Descripción detallada de la carga" },
      { nombre: "Peso (kg)", tipo: "número", longitud: "10", requerido: true, descripcion: "Peso bruto de la mercancía en kilogramos" },
      { nombre: "Estatus", tipo: "select", longitud: "—", requerido: true, descripcion: "Programado, En Tránsito, Entregado, Liquidado o Cancelado" },
    ],
    modales: [
      {
  ...
  },
  {
    ...
    campos: [
      { nombre: "Folio", tipo: "texto", longitud: "15", requerido: true, descripcion: "Identificador único de la orden de mantenimiento (autogenerado)" },
      { nombre: "Unidad", tipo: "select", longitud: "—", requerido: true, descripcion: "Unidad vehicular que recibirá el mantenimiento" },
      { nombre: "Tipo", tipo: "select", longitud: "—", requerido: true, descripcion: "Preventivo o Correctivo" },
      { nombre: "Categoría de Servicio", tipo: "select", longitud: "—", requerido: true, descripcion: "Ej. Motor, Frenos, Suspensión, Eléctrico, Carrocería, Llantas, Transmisión" },
      { nombre: "Descripción del Trabajo", tipo: "texto", longitud: "1000", requerido: true, descripcion: "Detalle de los trabajos realizados o por realizar" },
      { nombre: "Kilometraje al Servicio", tipo: "número", longitud: "10", requerido: true, descripcion: "Odómetro de la unidad al momento del mantenimiento" },
      { nombre: "Fecha de Inicio", tipo: "fecha", longitud: "—", requerido: true, descripcion: "Fecha en que inicia el mantenimiento" },
      { nombre: "Fecha de Fin", tipo: "fecha", longitud: "—", requerido: false, descripcion: "Fecha en que se completó el mantenimiento" },
      { nombre: "Mecánico / Taller", tipo: "select", longitud: "—", requerido: true, descripcion: "Mecánico interno asignado o taller externo que realiza el trabajo" },
      { nombre: "Costo de Mano de Obra", tipo: "moneda", longitud: "10", requerido: false, descripcion: "Costo del servicio de mano de obra en MXN" },
      { nombre: "Costo de Refacciones", tipo: "moneda", longitud: "10", requerido: false, descripcion: "Costo total de las refacciones utilizadas" },
      { nombre: "Costo Total", tipo: "moneda", longitud: "12", requerido: false, descripcion: "Suma de mano de obra + refacciones (calculado automáticamente)" },
      { nombre: "Próximo Servicio (km)", tipo: "número", longitud: "10", requerido: false, descripcion: "Kilometraje programado para el siguiente servicio preventivo" },
      { nombre: "Próximo Servicio (fecha)", tipo: "fecha", longitud: "—", requerido: false, descripcion: "Fecha programada para el siguiente servicio" },
      { nombre: "Estatus", tipo: "select", longitud: "—", requerido: true, descripcion: "Programado, En Proceso, Completado o Cancelado" },
    ],
    modales: [
      {
    ...
    faq: [
      ...
      {
        pregunta: "¿Puedo registrar mantenimientos realizados en talleres externos?",
        respuesta:
  ...
  },
  {
    ...
    funcionalidades: [
      ...
      "Importación masiva de cargas desde archivos CSV del proveedor de tarjetas",
      "Exportación de reportes de consumo a Excel",
    ],
    campos: [
      { nombre: "Folio de Carga", tipo: "texto", longitud: "15", requerido: true, descripcion: "Identificador único de la carga (autogenerado)" },
      { nombre: "Unidad", tipo: "select", longitud: "—", requerido: true, descripcion: "Unidad vehicular que recibió la carga" },
      { nombre: "Operador", tipo: "select", longitud: "—", requerido: true, descripcion: "Operador que realizó la carga" },
      { nombre: "Fecha y Hora", tipo: "fecha", longitud: "—", requerido: true, descripcion: "Fecha y hora en que se realizó la carga" },
      { nombre: "Estación / Gasolinera", tipo: "texto", longitud: "150", requerido: true, descripcion: "Nombre o razón social de la estación de servicio" },
      { nombre: "Tipo de Combustible", tipo: "select", longitud: "—", requerido: true, descripcion: "Diésel, Magna o Premium" },
      { nombre: "Litros", tipo: "número", longitud: "8", requerido: true, descripcion: "Cantidad de litros cargados" },
      { nombre: "Precio por Litro", tipo: "moneda", longitud: "6", requerido: true, descripcion: "Precio unitario del combustible en MXN" },
      { nombre: "Monto Total", tipo: "moneda", longitud: "10", requerido: true, descripcion: "Importe total de la carga (litros × precio, calculado automáticamente)" },
      { nombre: "Odómetro", tipo: "número", longitud: "10", requerido: true, descripcion: "Lectura del odómetro al momento de la carga" },
      { nombre: "Método de Pago", tipo: "select", longitud: "—", requerido: true, descripcion: "Tarjeta de combustible, Efectivo o Transferencia" },
      { nombre: "Número de Tarjeta", tipo: "texto", longitud: "20", requerido: false, descripcion: "Últimos 4 dígitos de la tarjeta de combustible utilizada" },
      { nombre: "Viaje Asociado", tipo: "select", longitud: "—", requerido: false, descripcion: "Viaje al que se asigna esta carga para costeo" },
      { nombre: "Estado de Conciliación", tipo: "select", longitud: "—", requerido: false, descripcion: "Pendiente, Conciliado o Discrepancia" },
    ],
    modales: [
      {
    ...
    faq: [
      ...
      },
      {
        ...
        respuesta:
          "Haz clic en 'Importar CSV'. Selecciona el archivo del proveedor de tarjetas, mapea las columnas (fecha, monto, litros, estación) y el sistema validará cada registro. Los registros con errores se muestran para corrección antes de confirmar la importación.",
      },
      {
  ...
  },
  {
    ...
    campos: [
      { nombre: "Folio de Documento", tipo: "texto", longitud: "20", requerido: true, descripcion: "Folio de la factura, nota de crédito o complemento de pago" },
      { nombre: "Tipo", tipo: "select", longitud: "—", requerido: true, descripcion: "Factura, Nota de Crédito, Complemento de Pago, Gasto" },
      { nombre: "Cliente / Proveedor", tipo: "select", longitud: "—", requerido: true, descripcion: "Entidad asociada al movimiento financiero" },
      { nombre: "Concepto", tipo: "texto", longitud: "300", requerido: true, descripcion: "Descripción del concepto facturado o del gasto" },
      { nombre: "Monto", tipo: "moneda", longitud: "14", requerido: true, descripcion: "Importe total del documento en MXN (sin IVA o con IVA según configuración)" },
      { nombre: "IVA", tipo: "moneda", longitud: "12", requerido: false, descripcion: "Monto del IVA desglosado" },
      { nombre: "Total", tipo: "moneda", longitud: "14", requerido: true, descripcion: "Monto + IVA (calculado automáticamente)" },
      { nombre: "Fecha de Emisión", tipo: "fecha", longitud: "—", requerido: true, descripcion: "Fecha en que se emitió el documento" },
      { nombre: "Fecha de Vencimiento", tipo: "fecha", longitud: "—", requerido: true, descripcion: "Fecha límite de pago según días de crédito del cliente" },
      { nombre: "Estatus de Pago", tipo: "select", longitud: "—", requerido: true, descripcion: "Pendiente, Parcial, Pagado o Cancelado" },
      { nombre: "Saldo Pendiente", tipo: "moneda", longitud: "14", requerido: false, descripcion: "Monto que falta por cobrar o pagar (calculado automáticamente)" },
      { nombre: "Viaje Asociado", tipo: "select", longitud: "—", requerido: false, descripcion: "Viaje o viajes vinculados a este documento" },
      { nombre: "Cuenta Bancaria", tipo: "select", longitud: "—", requerido: false, descripcion: "Cuenta bancaria donde se recibió o realizó el pago" },
      { nombre: "Método de Pago", tipo: "select", longitud: "—", requerido: false, descripcion: "Transferencia, Cheque, Efectivo, Tarjeta" },
    ],
    modales: [
      {
