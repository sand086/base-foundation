...
export interface UnidadCombustible {
  id: string;
  numero: string;
  capacidad_tanque_diesel: number; // Litros
  capacidad_tanque_urea: number; // Litros (typical DEF tank ~40-80L)
}
...
export const unidadesCombustible: UnidadCombustible[] = [
  {
    id: "U-001",
    numero: "TR-204",
    capacidad_tanque_diesel: 800,
    capacidad_tanque_urea: 60,
  },
  {
    id: "U-002",
    numero: "TR-118",
    capacidad_tanque_diesel: 600,
    capacidad_tanque_urea: 50,
  },
  {
    id: "U-003",
    numero: "TR-156",
    capacidad_tanque_diesel: 1000,
    capacidad_tanque_urea: 80,
  },
  {
    id: "U-004",
    numero: "TR-089",
