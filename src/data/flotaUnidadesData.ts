...
export function getAvailableUnits(): Unidad[] {
  return mockFleetUnits.filter(
    (u) => u.status === "disponible" && u.documentosVencidos === 0,
  );
}
...
export function getAvailableUnitsByType(
