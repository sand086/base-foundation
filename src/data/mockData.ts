...
export const mockUnit: Unit = {
  ...
  status: 'en_ruta',
  tires: [
    { id: 'TL-8821', position: 'Posición 1', marca: 'Michelin', profundidad: 4, estado: 'ponchada', renovado: 0, marcajeInterno: '3T-1125-361' },
    { id: 'TL-8822', position: 'Posición 2', marca: 'Bridgestone', profundidad: 9, estado: 'normal', renovado: 0, marcajeInterno: '3T-1126-105' },
    { id: 'TL-8823', position: 'Posición 3', marca: 'Goodyear', profundidad: 12, estado: 'normal', renovado: 2, marcajeInterno: '3T-1201-221' },
    { id: 'TL-8824', position: 'Posición 4', marca: 'Continental', profundidad: 6, estado: 'normal', renovado: 0, marcajeInterno: '3T-1201-222' },
    { id: 'TL-8825', position: 'Posición 5', marca: 'Michelin', profundidad: 11, estado: 'normal', renovado: 1, marcajeInterno: '3T-1202-301' },
    { id: 'TL-8826', position: 'Posición 6', marca: 'Michelin', profundidad: 10, estado: 'normal', renovado: 1, marcajeInterno: '3T-1202-302' },
    { id: 'TL-8827', position: 'Posición 7', marca: 'Bridgestone', profundidad: 8, estado: 'normal', renovado: 0, marcajeInterno: '3T-1202-303' },
    { id: 'TL-8828', position: 'Posición 8', marca: 'Bridgestone', profundidad: 7, estado: 'normal', renovado: 0, marcajeInterno: '3T-1202-304' },
  ],
  documents: [
