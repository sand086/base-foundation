...
export const mockTrips: Trip[] = [
  {
    ...
    timeline: [
      ...
      {
        time: "12:30",
        event: "Caseta Palmillas - Efectivo",
        type: "checkpoint",
      },
  ...
  },
  {
    ...
    timeline: [
      {
        time: "06:00",
        event: "Salida de origen - Puerto Veracruz",
        type: "checkpoint",
      },
  ...
  },
  {
    ...
    timeline: [
      ...
      {
        time: "07:30",
        event: "Caseta Monterrey Norte - TAG",
        type: "checkpoint",
      },
  ...
  },
  {
    ...
    timeline: [
      {
        time: "05:00",
        event: "Carga en puerto - Manzanillo",
        type: "checkpoint",
      },
...
export const mockFuelRecords: FuelRecord[] = [
  {
    ...
    litrosECM: 180.5,
    litrosTicket: 185.0,
    diferenciaPorcentaje: 2.5,
    estatus: "conciliado",
  },
  {
    id: "FUEL-002",
    viajeId: "SRV-2025-002",
    fecha: "2025-01-08",
    unidad: "TR-118",
    operador: "Roberto Martínez",
    kmsRecorridos: 380,
    litrosECM: 152.0,
    litrosTicket: 168.0,
    diferenciaPorcentaje: 10.5,
    estatus: "vale_cobro",
  },
  {
    id: "FUEL-003",
    viajeId: "SRV-2025-003",
    fecha: "2025-01-08",
    unidad: "TR-156",
    ...
    litrosECM: 208.0,
    litrosTicket: 212.5,
    diferenciaPorcentaje: 2.2,
    estatus: "conciliado",
  },
  {
    id: "FUEL-004",
    viajeId: "SRV-2025-004",
    fecha: "2025-01-07",
    unidad: "TR-089",
    ...
    litrosECM: 116.0,
    litrosTicket: 130.0,
    diferenciaPorcentaje: 12.1,
    estatus: "vale_cobro",
  },
  {
    id: "FUEL-005",
    viajeId: "SRV-2025-005",
    fecha: "2025-01-07",
    unidad: "TR-201",
    operador: "Fernando García",
    kmsRecorridos: 680,
    litrosECM: 272.0,
    litrosTicket: 278.0,
    diferenciaPorcentaje: 2.2,
