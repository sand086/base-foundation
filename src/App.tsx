              ...
              <Routes>
                ...
                <Route element={<ProtectedRoute />}>
                  ...
                  <Route path="/" element={<AppLayout />}>
                    ...
                    {/* MÓDULO: TRÁFICO */}
                    <Route
                      element={<ProtectedRoute requiredModule="traffic" />}
                    >
                      <Route
                    ...
                    {/* MÓDULO: CLIENTES */}
                    <Route
                      element={<ProtectedRoute requiredModule="clients" />}
                    >
                    ...
                    <Route
                      element={<ProtectedRoute requiredModule="payables" />}
                    >
                    ...
                    {/* MÓDULO: DESPACHO */}
                    <Route
                      element={<ProtectedRoute requiredModule="dispatch" />}
                    >
