  ...
  return (
    <div className="relative min-h-screen overflow-hidden flex flex-col bg-gradient-to-b from-[hsl(210,40%,97%)] via-[hsl(210,30%,94%)] to-[hsl(210,25%,88%)]">
      ...
      <img
        src={logo}
        alt="Logo"
        className="absolute top-5 left-5 sm:top-8 sm:left-15 w-35 sm:w-40 z-20 opacity-80"
      />

      {/* Clouds */}
      <svg
        className="absolute top-0 left-0 w-[300%] h-[25%] opacity-40 animate-[cloudDrift_60s_linear_infinite]"
        viewBox="0 0 4320 200"
      ...
      {/* Birds */}
      <svg
        className="absolute top-[12%] opacity-25 animate-[birdFly_14s_linear_infinite]"
        style={{ left: "-30px" }}
        width="28"
        height="14"
        viewBox="0 0 28 14"
      ...
      <svg
        className="absolute top-[8%] opacity-20 animate-[birdFly_18s_linear_infinite]"
        style={{ left: "-30px", animationDelay: "4s" }}
        width="22"
        height="11"
        viewBox="0 0 28 14"
      >
      ...
      <svg
        className="absolute top-[15%] opacity-15 animate-[birdFly_22s_linear_infinite]"
        style={{ left: "-30px", animationDelay: "8s" }}
        width="18"
        height="9"
        viewBox="0 0 28 14"
      >
      ...
      <svg
        className="absolute top-[10%] opacity-20 animate-[birdFly_16s_linear_infinite]"
        style={{ left: "-30px", animationDelay: "2s" }}
        width="24"
        height="12"
        viewBox="0 0 28 14"
      >
      ...
      <svg
        ...
        style={{ bottom: "48%", left: 0, right: 0, width: "100%" }}
      ...
      <div
        className="absolute z-[3] hidden sm:block"
      ...
      >
        ...
        >
          ...
          <text
            ...
            fontSize="5"
            fontWeight="bold"
            className="animate-[priceBlink_2s_ease-in-out_infinite]"
          >
            $0.00
          </text>
          <rect
          ...
          {/* Left hose */}
          <path
            d="M28 48 Q18 48 18 56 Q18 62 24 62"
            fill="none"
            stroke="hsl(220,8%,40%)"
            strokeWidth="1.5"
            strokeLinecap="round"
          ...
          {/* Right hose */}
          <path
            d="M72 48 Q82 48 82 56 Q82 62 76 62"
            fill="none"
            stroke="hsl(220,8%,40%)"
            strokeWidth="1.5"
            strokeLinecap="round"
      ...
      <div
        className="absolute z-[3] opacity-40 hidden sm:block"
        style={{ bottom: "48%", left: "6%" }}
      >
        <div className="flex flex-col items-center">
          <div className="w-10 h-10 rounded-full border-[3px] border-[hsl(var(--brand-red))] flex items-center justify-center bg-white/80">
            <span className="text-[hsl(var(--brand-red))] font-black text-xs">
              ⛔
            </span>
          </div>
      ...
      <div
        className="absolute z-[3] opacity-40 hidden lg:block"
      ...
      {/* Traffic light */}
      <div
        className="absolute z-[3] opacity-50 hidden md:flex flex-col items-center"
      ...
      {/* Sidewalk */}
      <div
        className="absolute left-0 right-0 h-[4%] bg-gradient-to-t from-[hsl(30,10%,62%)] to-[hsl(30,12%,72%)]"
        style={{ bottom: "44%" }}
      >
      ...
      {/* Road */}
      <div
        className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-[hsl(220,8%,24%)] via-[hsl(220,6%,32%)] to-[hsl(220,6%,38%)]"
        style={{ height: "44%" }}
      >
        <div className="absolute top-[30%] left-0 right-0 flex gap-14 px-8">
          {Array.from({ length: 18 }).map((_, i) => (
            <div
              key={i}
              className="h-[3px] w-14 flex-shrink-0 rounded bg-[hsl(48,85%,60%,0.45)]"
            />
          ))}
        </div>
        <div className="absolute top-[55%] left-0 right-0 flex gap-14 px-16">
          {Array.from({ length: 18 }).map((_, i) => (
            <div
              key={`b-${i}`}
              className="h-[2px] w-10 flex-shrink-0 rounded bg-[hsl(0,0%,50%,0.2)]"
            />
          ))}
        </div>
      </div>
      ...
      <div
        className="absolute z-[5] animate-[tumbleweed_14s_linear_infinite]"
        style={{ bottom: "34%" }}
      >
        <svg
          width="60"
          height="60"
          viewBox="0 0 40 40"
          className="animate-[tumbleweedSpin_1.8s_linear_infinite] opacity-60"
        >
          <circle
            cx="20"
            cy="20"
          ...
          />
          <path
            d="M6 15 Q20 18 34 12"
            fill="none"
            stroke="hsl(35,38%,52%)"
            strokeWidth="0.5"
          />
          <path
            d="M8 28 Q22 24 36 30"
            fill="none"
            stroke="hsl(35,38%,52%)"
            strokeWidth="0.5"
          />
          <path
            d="M12 4 Q18 20 14 36"
            fill="none"
            stroke="hsl(35,32%,48%)"
            strokeWidth="0.4"
          />
          <path
            d="M28 6 Q24 22 30 38"
            fill="none"
            stroke="hsl(35,32%,48%)"
            strokeWidth="0.4"
          />
      ...
      <div
        className="absolute z-[5] animate-[tumbleweed_18s_linear_infinite] hidden sm:block"
        style={{ bottom: "28%", animationDelay: "6s" }}
      >
        <svg
          width="48"
          height="48"
          viewBox="0 0 40 40"
          className="animate-[tumbleweedSpin_1.5s_linear_infinite] opacity-45"
        >
          <circle
            cx="20"
            cy="20"
