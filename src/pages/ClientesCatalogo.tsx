...
import { Users, Plus, Search, Building2, MapPin, MoreHorizontal, Eye, Edit, Trash2, ChevronDown, ChevronRight, Phone, Clock } from "lucide-react";
...
const getOperationBadge = (tipo: string) => {
  switch (tipo) {
    case 'nacional':
      return <Badge variant="outline" className="text-xs bg-emerald-50 text-emerald-700 border-emerald-200">Nacional</Badge>;
    case 'importación':
      return <Badge variant="outline" className="text-xs bg-blue-50 text-blue-700 border-blue-200">Import</Badge>;
    case 'exportación':
      return <Badge variant="outline" className="text-xs bg-amber-50 text-amber-700 border-amber-200">Export</Badge>;
    default:
      return null;
  }
};
  ...
  return (
    <div className="space-y-6">
      ...
      <PageHeader 
        ...
        description="Administra clientes y sus destinos de entrega"
      >
          ...
          <Table>
            <TableHeader>
              <TableRow className="bg-gray-50">
                ...
                <TableHead className="text-xs font-semibold uppercase text-slate-600 tracking-wider text-center">Destinos</TableHead>
