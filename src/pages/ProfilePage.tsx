          ...
          <div className="flex items-center gap-6">
            <div className="relative">
              <Avatar className="h-24 w-24 border-4 border-background shadow-lg">
                <AvatarImage
                  src={profile.avatar?.trim() ? profile.avatar : AvatarDefault}
                  alt={profile.nombre}
                />
            ...
            <div className="flex-1">
              <div className="flex items-center gap-3">
                ...
                <Badge
                  variant="outline"
                  className={cn("text-xs", getRoleBadgeColor(profile.rol))}
                >
      ...
      >
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Esta acción reducirá la seguridad de tu cuenta. Ingresa tu
