...
export default function FinanceDashboard() {
  ...
  const cashFlowData = useMemo(() => generateCashFlowProjection(), []);
  ...
  // Calculate totals
  const totalCostosDirectos = Object.values(monthlyData.costosDirectos).reduce(
    (a, b) => a + b,
    0,
  );
  const totalGastosMantenimiento = Object.values(
    monthlyData.gastosMantenimiento,
  ).reduce((a, b) => a + b, 0);
  const totalGastosIndirectos = Object.values(
    monthlyData.gastosIndirectos,
  ).reduce((a, b) => a + b, 0);

  const utilidadBruta = monthlyData.facturacionTotal - totalCostosDirectos;
  const utilidadNeta =
    utilidadBruta - totalGastosMantenimiento - totalGastosIndirectos;
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Card
          className={`md:col-span-1 border-l-4 ${utilidadNeta > 0 ? "border-l-emerald-500 bg-emerald-50/50" : "border-l-rose-500 bg-rose-50/50"}`}
        >
          ...
          <CardContent>
            <p
              className={`text-3xl font-bold ${utilidadNeta > 0 ? "text-emerald-700" : "text-rose-700"}`}
            >
        ...
        <CardContent>
          <div className="space-y-3">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-blue-600">
                    Ingresos por fletes y servicios
                  </p>
                </div>
              </div>
            ...
            <div className="ml-4 pl-4 border-l-2 border-dashed border-slate-300 space-y-2">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
                <div className="p-2 bg-rose-50 rounded border border-rose-100">
                  ...
                  <p className="font-semibold text-rose-700 text-sm">
                    -{formatMoney(monthlyData.costosDirectos.diesel)}
                  </p>
                </div>
                <div className="p-2 bg-rose-50 rounded border border-rose-100">
                  <div className="flex items-center gap-2 mb-1">
                  ...
                  <p className="font-semibold text-rose-700 text-sm">
                    -{formatMoney(monthlyData.costosDirectos.casetas)}
                  </p>
                </div>
                <div className="p-2 bg-rose-50 rounded border border-rose-100">
                  <div className="flex items-center gap-2 mb-1">
                  ...
                  <p className="font-semibold text-rose-700 text-sm">
                    -{formatMoney(monthlyData.costosDirectos.pagosOperadores)}
                  </p>
                </div>
                <div className="p-2 bg-rose-50 rounded border border-rose-100">
                  <div className="flex items-center gap-2 mb-1">
                  ...
                  <p className="font-semibold text-rose-700 text-sm">
                    -{formatMoney(monthlyData.costosDirectos.gastosViaje)}
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between p-2 bg-slate-100 rounded">
                ...
                <span className="font-bold text-rose-700">
                  -{formatMoney(totalCostosDirectos)}
                </span>
              </div>
            </div>
            ...
            <div className="ml-4 pl-4 border-l-2 border-dashed border-slate-300 space-y-2">
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
                <Minus className="h-3 w-3" />
                <span className="font-medium">Gastos de Maintenance</span>
              </div>
              ...
              <div className="grid grid-cols-2 gap-2">
                <div className="p-2 bg-orange-50 rounded border border-orange-100">
                  ...
                  <p className="font-semibold text-orange-700 text-sm">
                    -{formatMoney(monthlyData.gastosMantenimiento.refacciones)}
                  </p>
                </div>
                <div className="p-2 bg-orange-50 rounded border border-orange-100">
                  <div className="flex items-center gap-2 mb-1">
                  ...
                  <p className="font-semibold text-orange-700 text-sm">
                    -{formatMoney(monthlyData.gastosMantenimiento.manoObra)}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="ml-4 pl-4 border-l-2 border-dashed border-slate-300 space-y-2">
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
                ...
                <span className="font-medium">
                  Gastos Indirectos (Oficina/Admin)
                </span>
              </div>
              ...
              <div className="flex items-center justify-between p-2 bg-slate-100 rounded">
                ...
                <span className="font-bold text-slate-700">
                  -{formatMoney(totalGastosIndirectos)}
                </span>
              </div>
            </div>
            ...
            {/* Utilidad Neta */}
            <div
              className={`flex items-center justify-between p-4 rounded-lg border-2 ${utilidadNeta > 0 ? "bg-emerald-50 border-emerald-300" : "bg-rose-50 border-rose-300"}`}
            >
              <div className="flex items-center gap-3">
                <div
                  className={`p-2 rounded-lg ${utilidadNeta > 0 ? "bg-emerald-200" : "bg-rose-200"}`}
                >
                  {utilidadNeta > 0 ? (
                ...
                <div>
                  <p
                    className={`font-bold ${utilidadNeta > 0 ? "text-emerald-900" : "text-rose-900"}`}
                  >
                    = UTILIDAD NETA OPERATIVA
                  </p>
                  <p
                    className={`text-xs ${utilidadNeta > 0 ? "text-emerald-600" : "text-rose-600"}`}
                  >
              ...
              <p
                className={`text-2xl font-bold ${utilidadNeta > 0 ? "text-emerald-700" : "text-rose-700"}`}
              >
                {formatMoney(utilidadNeta)}
              </p>
            </div>
          ...
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              ...
              <Badge
                ...
                className={
                  cashFlowIsPositive
                    ? "text-emerald-700 border-emerald-300 ml-auto"
                    : "text-rose-700 border-rose-300 ml-auto"
                }
              >
            ...
            <div className="mt-4 grid grid-cols-3 gap-2 text-center">
              <div className="p-2 bg-emerald-50 rounded">
                ...
                <p className="font-bold text-emerald-700 text-sm">
                  {formatMoney(lastCashFlowPoint?.cobrosEsperados || 0)}
                </p>
              </div>
              <div className="p-2 bg-rose-50 rounded">
                ...
                <p className="font-bold text-rose-700 text-sm">
                  {formatMoney(lastCashFlowPoint?.pagosComprometidos || 0)}
                </p>
              </div>
              <div
                className={`p-2 rounded ${cashFlowIsPositive ? "bg-emerald-100" : "bg-rose-100"}`}
              >
                <p
                  className={`text-xs ${cashFlowIsPositive ? "text-emerald-600" : "text-rose-600"}`}
                >
                  Diferencia
                </p>
                <p
                  className={`font-bold text-sm ${cashFlowIsPositive ? "text-emerald-700" : "text-rose-700"}`}
                >
            ...
            {!cashFlowIsPositive && (
              <div className="mt-4 p-3 bg-rose-50 border border-rose-200 rounded-lg flex items-start gap-2">
                ...
                <div className="text-sm text-rose-800">
                  ...
                  <p className="text-xs">
                    Los pagos comprometidos superan los cobros esperados. Revisa
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Badge variant="outline" className="">
                      {((expense.monto / totalGastosIndirectos) * 100).toFixed(
                        0,
                      )}
                      %
                    </Badge>
