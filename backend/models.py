...
class Tariff(Base):
    ...
    nombre_ruta = Column(String(200), nullable=False)  # Ej: "CDMX - Monterrey (Vía Saltillo)"
...
class Operator(Base):
    ...
    license_expiry = Column(Date, nullable=False)  # CRÍTICO: Para alertas de vencimiento
